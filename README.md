...
### Repositório possuí projeto desenvolvido durante um modulo de um curso, abordando os conceitos de <b>API Rest</b> com CRUD completo e seus endpoints.
...
- Responsabilidades específicas para cada parte do seu app;
...
```bash
# Clone o repositório
  git clone git@github.com:leandrcosta/Store-Manager.git
